            ...
            <div className="flex items-center gap-2">
              {SOCIALS.map(({ label, href, Icon }) => (
                <Link
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex h-10 w-10 items-center justify-center rounded-[0.95rem] border-2 border-line bg-surface-2 text-ink shadow-[0_5px_0_var(--shadow-color)] transition-colors hover:bg-surface-3"
                >
